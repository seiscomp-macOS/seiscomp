...
MACRO(FIND_FLEX)
    IF(APPLE)
        IF (EXISTS "/Library/Developer/CommandLineTools/usr/include/FlexLexer.h" )
            ...
            MESSAGE(STATUS "macOS default /usr/bin/flex and header FlexLexer.h found.")
        ELSE()
            MESSAGE(STATUS "macOS default flex from Xcode or CommandLineTools not found! Checking Homebrew version of flex.")
